...
We now identify some of the negative impacts of excessive social media use on mental and physical health. Although our research does not directly aim at rectifying them, we deem this crucial to understand the personal technology climate in mass society. We hope to show that by allowing Goodscroll a place in the user's daily lives, we can help mollify some of the dissatisfaction users express with their current social media habits. 
